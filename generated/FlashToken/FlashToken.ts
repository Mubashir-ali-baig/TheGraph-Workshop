...
export class FlashToken extends ethereum.SmartContract {
  static bind(address: Address): FlashToken {
    return new FlashToken("FlashToken", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get flashProtocol(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get flashClaim(): Address {
